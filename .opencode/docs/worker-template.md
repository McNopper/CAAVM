...
## About this document
- **Kind:** `agent` (template — copied to create a worker instance)
- **Read by:** the PM agent (to spawn) and the spawned worker; **written by:** maintainers
- **Related:** the PM agent (`.opencode/agent/pm.md`) copies this per role/instance
